...
public class StudentController {
    ...
    public String newStudent(Model model){
        //student model object to store form data
        StudentDto studentDto = new StudentDto();
        model.addAttribute("student" , studentDto);
        return "create_student";
    }

    //handler method to handle save  students form submit request
    ...
    public String updateStudent(@PathVariable Long studentId, @Valid @ModelAttribute("student") StudentDto studentDto, BindingResult result , Model model){
